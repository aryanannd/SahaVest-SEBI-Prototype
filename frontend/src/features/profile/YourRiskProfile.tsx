...
export function YourRiskProfile() {
    ...
    <div className="bg-background text-on-background min-h-screen flex flex-col font-sans">
      ...
      <header className="w-full sticky top-0 z-50 bg-surface border-b border-outline-variant">
        <div className="flex items-center justify-between px-4 py-3 w-full max-w-7xl mx-auto">
          <div 
            onClick={() => navigate('/')}
            className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-surface-container-low transition-colors active:scale-95 duration-100 cursor-pointer"
          >
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 py-8 max-w-7xl mx-auto w-full relative overflow-hidden">
        {/* Abstract Background Element for 'Zen' feel */}
        ...
        <div className="relative z-10 w-full max-w-lg flex flex-col items-center text-center space-y-8">
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <h2 className="font-display-lg-mobile md:font-display-lg text-primary uppercase tracking-widest text-2xl font-bold">MODERATE RISK</h2>
          </div>
          ...
          <div className="w-full flex flex-col space-y-4 pt-6">
            <button 
              ...
              className="w-full h-[56px] rounded-lg bg-primary text-on-primary font-label-md hover:bg-primary/90 transition-colors active:scale-[0.98]"
            >
              Continue
            </button>
            <button 
